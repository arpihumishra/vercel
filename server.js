...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      tenants: {
        'GET /api/tenants/:slug': 'Get tenant information (requires auth, same tenant)',
        'POST /api/tenants/:slug/upgrade': 'Upgrade tenant to Pro plan (requires auth, admin role)'
      },
      notes: {
